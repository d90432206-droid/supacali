...
import { LayoutDashboard, PlusCircle, List, Settings, Database, LogOut, Wifi, WifiOff, Database as DatabaseIcon, ShieldCheck, User, Calculator } from 'lucide-react';
  ...
  return (
    <div className="w-full h-full bg-slate-900 flex flex-col p-4 text-slate-100">
      <div className="flex items-center gap-3 px-2 mb-8 mt-4">
        ...
        <div className="flex-shrink-0">
          {!logoError ? (
            ...
            <div className="bg-brand-500 w-12 h-12 rounded-lg flex items-center justify-center font-bold text-white shadow-lg shadow-brand-500/20 text-lg">
              CC
            </div>
          )}
        </div>
      ...
      <nav className="flex-1 space-y-1">
        ...
        <p className="px-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-3">工具與設定</p>
        <NavItem view="tools" icon={<Calculator size={18} />} label="實用工具箱" />
